    ...
    <div className="slider-container"  >
      <Slider {...settings}>
        <Box  height={"500px"} textAlign={"center"} alignItems={"center"} alignContent={"center"} backgroundSize={" 1000px"} backgroundPosition={"center"} backgroundImage={"https://blog.theluxurycloset.com/wp-content/uploads/2020/11/shutterstock_1519162370-680x400.jpg"} >
         ...
         <Link to="/shoes"><button style={{backgroundColor:"white", color:"black", width:"150px" , height:"50px"}}>SHOP VALENTINO</button></Link> 
        </Box>
      ...
      <Link to="/handbags"> <button style={{backgroundColor:"white", color:"black", width:"150px" , height:"50px"}}>SHOP NOW</button></Link>
       </Box>
     ...
     <Link to="/designers"> <button style={{backgroundColor:"black", color:"white", width:"150px" , height:"50px"}}>SHOP NOW</button></Link> 
       </Box>
